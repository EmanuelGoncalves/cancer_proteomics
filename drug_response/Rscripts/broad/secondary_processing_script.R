...
treatment_info_path = "./data/ccle/secondary-screen-replicate-treatment-info.csv"
pooling_info_path = "./data/ccle/secondary-screen-pooling-info.csv"
secondary_MFI_path = "./data/ccle/secondary-screen-mfi.csv"
...
ARTIFACTS %>%
  write_csv("./data/ccle/secondary_outlier_pools.csv")

SSMD_TABLE %>%
  write_csv("./data/ccle/secondary_ssmd_table.csv")

DATA %>% 
  reshape2::acast(row_name ~ column_name, value.var = "log2.Viability.cb") %>%
  write.csv("./data/ccle/secondary_logfold_change.csv")
...
DATA.median.collapsed %>%
  ...
  write.csv("./data/ccle/secondary_replicate_collapsed_logfold_change.csv")

DRC_TABLE %>%
  write_csv("./data/ccle/secondary_drc_table.csv")