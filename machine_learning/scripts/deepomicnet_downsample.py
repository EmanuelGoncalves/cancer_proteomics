...
for run_name in downsample_df.columns:
    ...
    ic50_selected_pivot = pd.pivot(ic50_selected[['cell_line_name', 'drug_id', configs['target']]],
    ...
    if configs['do_cv']:
        ...
        for cell_lines_train_index, cell_lines_val_index in cv.split(cell_lines_train):
            ...
            if configs['data_type'] != 'protein_rep':
                ...
                val_data = data_sample_train[data_sample_train['Cell_line'].isin(val_lines)].drop(
